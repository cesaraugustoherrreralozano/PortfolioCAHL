      ...
      <div className="bg-white px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
        <div className="relative mx-auto max-w-lg divide-y-2 divide-gray-200 lg:max-w-7xl">
          <div className="text-center">
            <h2 className="mx-auto text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Recent publications</h2>
            <p className="mt-3 text-xl text-gray-500 sm:mt-4">
            Explore the rich repository of knowledge and insights within our business solution blogs at <span className="text-blue-900 hover:text-blue-700">CAHL Analytics</span>.
            </p>
          </div>
