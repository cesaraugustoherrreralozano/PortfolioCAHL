    ...
    return(
        ...
        <section className='p-32'>
            <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
                ...
                <p class="max-w-xl mx-auto mt-8 text-base leading-relaxed text-center text-gray-500">Explore the porftolio with cases and insights within our business solution <br/>at CAHL Analytics.</p>

                <Link to="/Services" class="mx-auto mt-8 text-sm font-semibold text-blue-600 hover:text-neutral-600" title="read more"> Read more about our services » </Link>
                </div>
            </div>
        </section>
